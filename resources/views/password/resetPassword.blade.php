            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ URL::route('changePasswordPost') }}">
                            {!! csrf_field() !!}
                    ...
                    {{--<div class="panel-footer">--}}
                        {{--<a class="btn btn-primary" href="{{ URL::route('index') }}">{{ trans('views\accountPage.back') }}</a>--}}
                    {{--</div>--}}
                </div>
            </div>
        </div>
