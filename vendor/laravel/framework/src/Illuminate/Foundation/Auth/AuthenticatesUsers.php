...
trait AuthenticatesUsers
{
    ...
    public function login(Request $request)
    {
        ...
        //cookie ce se izbere remember field
    ...
    /**
     * Get the failed non active user message
     * by aSrsa
     */
    protected function getNonActiveMessage() {
        return Lang::has('auth.nonActive')
            ? Lang::get('auth.nonActive')
            : 'Account has to be activated before logging.';
    }
